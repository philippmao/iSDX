...
\rb{explain this test as well. what did you measure? withdraws/updates/both? how many times did you repeat it? I would probably change to absolute values instead of the relative ones, then it is probably easier to show why it takes that much longer with 500k prefixes.}
...
\rb{again explain what kind of test did you run:  what did you measure? withdraws/updates/both? how many times did you repeat it?}
